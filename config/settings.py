...
KIS_BASE_URL = 'https://openapivts.koreainvestment.com:29443' if KIS_IS_MOCK else 'https://openapi.koreainvestment.com:9443'
...
EMERGENCY_STOP_RATE  = float(os.getenv('EMERGENCY_STOP_RATE', '0.08'))  # 즉시 손절 (캔들 확인 없음)
...
MARKET_CRASH_GUARD_RATE = float(os.getenv('MARKET_CRASH_GUARD_RATE', '1.0'))
